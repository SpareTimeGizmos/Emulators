//++
// SCMP.cpp - SC/MP Emulator main program
//
// DESCRIPTION:
...
CSCMP3          *g_pCPU         = NULL; // SC/MP-II CPU
...
{
  //++
  // Here's the main program for the SC/MP Emulator .
  //--
  ...
  CMDOUTF("SC/MP-III Emulator v%d emulator Library v%d", SCMPVER, EMUVER);
  ...
  g_pCPU = DBGNEW CSCMP3(g_pMemory, g_pEvents);
