//++
// UserInterface.hpp -> UserInterface for PEV2 Emulator
//
...
//
// DESCRIPTION:
//   This class implements the PEV2 specific user interface (as opposed to the
...
private:
  ...
  static const CCmdArgKeyword::KEYWORD m_keysInvert[];

  // Argument tables ...
private:
  static CCmdArgFileName    m_argFileName, m_argOptFileName;
  static CCmdArgKeyword     m_argFileFormat, m_argInvert;
  static CCmdArgKeyword     m_argStopOpcode, m_argStopIO;
  ...
  static CCmdArgNumber      m_argBreakChar, m_argBaudRate;
