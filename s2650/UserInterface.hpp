//++
// UserInterface.hpp -> UserInterface for 2650 Emulator
//
//   This class implements the SBC50 specific user interface (as opposed to the
...
private:
  ...
  static CCmdVerb m_cmdClearRAM, m_cmdClearMemory;
  ...
  static CCmdVerb m_cmdShowAll, m_cmdShowVersion, m_cmdShowTime;
  static CCmdVerb m_cmdShowConfiguration, m_cmdShowMemory, m_cmdShowCPU;
...
private:
  ...
  static bool DoShowCPU(CCmdParser& cmd), DoShowTime(CCmdParser &cmd);
  static bool DoClearRAM(CCmdParser &cmd), DoClearMemory(CCmdParser &cmd);
